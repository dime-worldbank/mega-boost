...
def run_script(nb_relpath, env=None, cwd=None):
    ...
    injected globals (e.g. TGO_ETL reads INPUT_DIR/OUTPUT_DIR). `cwd` sets the working dir so
    ...
    result = subprocess.run(
        ...
        env=child_env, capture_output=True, text=True, cwd=cwd,
    )
