...
country_codes = ['moz', 'pry', 'ken', 'pak', 'bfa', 'col', 'cod', 'nga', 'tun', 'btn', 'bgd', 'alb', 'ury', "zaf", 'chl', 'gha', 'tgo', 'lbr', 'per', 'bdi']
...
def boost_gold():
    ...
    for code in country_codes:
        table_name = f'{catalog}.{country_source_schema}.{code}_boost_gold'
