...
for sheet_name in ['Data_Expenditures', 'Data_Revenues']:
    ...
    assert len(df) >= min_num_rows, f"Number of rows in sheet are less than expected {min_num_rows}, got {df.shape[0]}."
