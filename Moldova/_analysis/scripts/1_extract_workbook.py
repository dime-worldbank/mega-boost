"""Phase 1: Excel archaeology for Moldova BOOST workbook.
...
def main():
    ...
    # defined names (named ranges) — critical when the workbook formulas use them
    ...
    # ---- FINDINGS.md ----
    lines = []
    lines.append("# Moldova BOOST — Phase 1 Findings\n")
    ...
    lines.append("- Phase 2: hand-translate each archetype group into PySpark in `MDA_transform_load_raw_dlt.py`.")
